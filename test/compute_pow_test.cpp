...
TEST(MuComputePow, RationalPowersOf2) {
  ASSERT_LONG_DOUBLE_EQ((compute_rational_pow(2, {1, 2})),
                        1.4142135623730950488);
  ASSERT_LONG_DOUBLE_EQ((compute_rational_pow(2, {3, 2})),
                        2.8284271247461900976);
  ASSERT_LONG_DOUBLE_EQ((compute_rational_pow(2, {50, 26})),
                        3.7923100573566858585);
  ASSERT_LONG_DOUBLE_EQ((compute_rational_pow(2, {41, 2})),
